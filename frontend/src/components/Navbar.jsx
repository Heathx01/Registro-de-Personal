    ...
    <header className="navbar">
      <div className="navbar-inner">
        ...
        <div className="user-widget">
          ...
          <div style={{ position: 'relative', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: '0 10px' }} title="Notificaciones">
            ...
            <span style={{
              ...
              fontSize: '0.6rem', fontWeight: 'bold', padding: '2px 5px', borderRadius: '10px'
            }}>
              3
            </span>
          </div>
