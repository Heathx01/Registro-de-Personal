...
export default function Navbar({ currentUser, activeTab, setActiveTab, onLogout, onSwitchRole, MOCK_USERS }) {
  return (
    <>
      <header className="navbar">
        <div className="navbar-inner">
          <div className="brand">
            <div className="brand-logo">Dev</div>
      ...
      {/* Banner interactivo para cambio rápido entre vistas */}
      <div className="demo-banner">
        <span>⚡ <strong>Evaluación Rápida de Roles:</strong> Haz clic para ingresar como Manager, Programador o CEO:</span>
        <div className="switcher-buttons">
          {MOCK_USERS.map((u) => (
            <button
              key={u.id}
              className={`role-switch-btn ${currentUser.id === u.id ? 'active' : ''}`}
